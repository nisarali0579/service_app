...
class CategoriesScreen_1 extends StatefulWidget {
  static String id = 'CategoriesScreen_1';
  @override
  _CategoriesScreen_1State createState() => _CategoriesScreen_1State();
}

class _CategoriesScreen_1State extends State<CategoriesScreen_1> {
  @override
    ...
    return Padding(
      ...
      child: Material(
        ...
        shape: RoundedRectangleBorder(
            ...
            side: BorderSide(color: Colors.yellow,style: BorderStyle.solid,width: 3)),
